...
class EmployerSeeder extends Seeder
{
    ...
    private const EMPLOYER_DATA = [
        ...
        ['company_name' => 'Northern Mindanao Logistics', 'contact_person' => 'Francis Tiu', 'email' => 'employer16@nminlogistics.com', 'industry' => 'Logistics', 'company_size' => '51-200', 'business_type' => 'Corporation', 'founded' => 2014, 'city' => 'Cagayan de Oro', 'province' => 'Misamis Oriental', 'barangay' => 'Lapasan', 'address_full' => 'Lapasan, Cagayan de Oro, Misamis Oriental', 'phone' => '09170010016', 'website' => 'https://nminlogistics.com', 'latitude' => 8.4542, 'longitude' => 124.6319, 'status' => 'verified', 'verified_days_ago' => 31, 'total_hired' => 17],
        ['company_name' => 'Zamboanga Marine Foods', 'contact_person' => 'Jasmine Khu', 'email' => 'employer17@zambomarinefoods.com', 'industry' => 'Food Processing', 'company_size' => '51-200', 'business_type' => 'Corporation', 'founded' => 2011, 'city' => 'Zamboanga City', 'province' => 'Zamboanga del Sur', 'barangay' => 'Canelar', 'address_full' => 'Canelar, Zamboanga City, Zamboanga del Sur', 'phone' => '09170010017', 'website' => 'https://zambomarinefoods.com', 'latitude' => 6.9214, 'longitude' => 122.0790, 'status' => 'verified', 'verified_days_ago' => 26, 'total_hired' => 14],
        ['company_name' => 'General Santos Cold Chain', 'contact_person' => 'Melvin Gadia', 'email' => 'employer18@gscoldchain.com', 'industry' => 'Logistics', 'company_size' => '51-200', 'business_type' => 'Corporation', 'founded' => 2013, 'city' => 'General Santos City', 'province' => 'South Cotabato', 'barangay' => 'Labangal', 'address_full' => 'Labangal, General Santos City, South Cotabato', 'phone' => '09170010018', 'website' => 'https://gscoldchain.com', 'latitude' => 6.1164, 'longitude' => 125.1716, 'status' => 'verified', 'verified_days_ago' => 24, 'total_hired' => 19],
        ['company_name' => 'Butuan Build and Energy', 'contact_person' => 'Louise Manatad', 'email' => 'employer19@butuanbuildenergy.com', 'industry' => 'Engineering', 'company_size' => '51-200', 'business_type' => 'Corporation', 'founded' => 2010, 'city' => 'Butuan City', 'province' => 'Agusan del Norte', 'barangay' => 'Bancasi', 'address_full' => 'Bancasi, Butuan City, Agusan del Norte', 'phone' => '09170010019', 'website' => 'https://butuanbuildenergy.com', 'latitude' => 8.9495, 'longitude' => 125.5438, 'status' => 'verified', 'verified_days_ago' => 22, 'total_hired' => 13],
        ['company_name' => 'Cotabato Community Services', 'contact_person' => 'Hannah Samama', 'email' => 'employer20@cotabatocomserve.com', 'industry' => 'Public Service', 'company_size' => '11-50', 'business_type' => 'Non-Profit', 'founded' => 2019, 'city' => 'Cotabato City', 'province' => 'Maguindanao del Norte', 'barangay' => 'Rosary Heights', 'address_full' => 'Rosary Heights, Cotabato City, Maguindanao del Norte', 'phone' => '09170010020', 'website' => 'https://cotabatocomserve.com', 'latitude' => 7.2236, 'longitude' => 124.2464, 'status' => 'verified', 'verified_days_ago' => 15, 'total_hired' => 6],
    ];
    ...
    private function jobsForEmployer(int $index, string $email): array
    {
        ...
        $jobs = [
            ...
            self::JOB_TEMPLATES[($start + 1) % count(self::JOB_TEMPLATES)],
        ];
    ...
    private function buildNearbyEmployers(array $baseEmployers): array
    {
        ...
        foreach ($baseEmployers as $i => $base) {
            // Deterministic spread: 2..4 nearby companies per base company.
            $nearbyCount = 2 + ($i % 3);
