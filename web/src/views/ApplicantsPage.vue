<template>
  <div class="layout-wrapper">
    <AppSidebar active-page="Applicants" />
    <div class="main-area">
      <AppTopbar title="Applicants" subtitle="Manage and monitor all registered jobseekers" />
      <div class="page">
<!-- Stats Strip -->
        ...
        <div class="drawer">
          ...
          <div class="drawer-body">
            ...
            <div v-if="drawerTab === 'Status'">
              ...
              <textarea class="notes-area" placeholder="Add notes about this applicant…" rows="4">{{ selected?.notes }}</textarea>
...
.strip-stat {
  ...
  padding: 14px 12px; border-right: 1px solid #f1f5f9;
}
