      ...
      <div class="auth-box">
        ...
        <transition name="slide-fade" mode="out-in">
          <div v-if="step === 1" key="step1">
            <div class="back-link" @click="$router.push('/employer/login')">
            ...
            <div class="info-box">
              ...
              <span>Make sure to use the email address linked to your PESO employer account.</span>
            </div>
          ...
          <div v-else-if="step === 2" key="step2">
            ...
            <div class="success-state">
              ...
              <router-link to="/employer/login" class="btn-outline-full">
...
export default {
  ...
  methods: {
    ...
    async handleSendReset() {
      ...
      this.sending = true
      try {
        await api.post('/employer/forgot-password', { email: this.email })
        this.step = 2
