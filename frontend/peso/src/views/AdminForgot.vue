      ...
      <div class="auth-box">
        ...
        <transition name="slide-fade" mode="out-in">
          <div v-if="step === 1" key="step1">
            <div class="back-link" @click="$router.push('/admin/login')">
            ...
            <div class="info-box">
              ...
              <span>Make sure to use the email address linked to your PESO Admin/Staff account.</span>
            </div>
          ...
          <div v-else-if="step === 2" key="step2">
            ...
            <div class="success-state">
              ...
              <router-link to="/admin/login" class="btn-outline-full">
...
export default {
  ...
  methods: {
    ...
    async handleSendReset() {
      ...
      this.sending = true
      try {
        await api.post('/admin/forgot-password', { email: this.email })
        this.step = 2
