<template>
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <!-- Dashboard on top (above MAIN MENU) -->
      <ul class="nav-list">
...
export default {
  ...
  data() {
    return {
      ...
      bottomNavItems: [
        { name: 'Profile', path: '/dashboard/profile', icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>` },
        { name: 'Users', path: '/dashboard/users', icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>` },
      ],
    }
  },
}
